...
plt.xlabel('r/d')
plt.ylabel('K$_{tn}$')
plt.title('Curvas de K$_{tn}$ por ajuste makima para pieza con radio 11.25 mm')
plt.legend(loc='best')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.xlabel('H/d')
plt.ylabel('K$_{tn}$')
plt.title('Interpolación de K$_{tn}$ por makima para una pieza con radio 11.25 mm')
plt.legend(loc='best')
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.title('Curvas S-N ajustadas por makima para una pieza con radio 11.25 mm')
plt.legend()
